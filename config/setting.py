...
# 模擬資料設定（用於測試）
MOCK_PRODUCTION_SUMMARY = config["MOCK_PRODUCTION_SUMMARY"]
MOCK_DOWNTIME_SUMMARY = config["MOCK_DOWNTIME_SUMMARY"]
MOCK_YIELD_SUMMARY = config["MOCK_YIELD_SUMMARY"]
MOCK_ANOMALY_TREND = config["MOCK_ANOMALY_TREND"]
MOCK_KPI_SUMMARY = config["MOCK_KPI_SUMMARY"]
MOCK_ISSUE_TRACKER = config["MOCK_ISSUE_TRACKER"]
